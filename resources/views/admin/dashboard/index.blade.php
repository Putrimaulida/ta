...
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex flex-column align-items-left justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dashboard</h1>
        <h5>Hi, Selamat Datang Kembali</h5>
    </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Pantai</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalCountPantai }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Total Jenis Mangrove</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalCountMangrove }}</div>
                        </div>
                        <div class="col-auto">
