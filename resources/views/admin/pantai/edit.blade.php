            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/dashboard_admin/pantai/update/' . $pantai->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_pantai" id="nama_pantai" class="form-control"
                                    value="{{ $pantai->nama_pantai }}" required>
                            </div>
                            <!-- Lokasi -->
                            <div class="form-group">
                                <label for="lokasi_pantai">Lokasi:</label>
                                <input type="text" name="lokasi_pantai" id="lokasi_pantai" class="form-control"
                                    value="{{ $pantai->lokasi_pantai }}" required>
                            </div>
                            <!-- Longitude -->
                            <div class="form-group">
                                <label for="longitude">Longitude:</label>
                                <input type="text" name="longitude" id="longitude" class="form-control"
                                    value="{{ $pantai->longitude }}" required>
                            </div>
                            <!-- Latitude -->
                            <div class="form-group">
                                <label for="latitude">Latitude:</label>
                                <input type="latitude" name="latitude" id="latitude" class="form-control"
                                    value="{{ $pantai->latitude }}" required>
                            </div>
                                        ...
                                        <div class="input-group">
                                            <select name="jenis_mangrove_id[]" class="form-control" required>
                                                ...
                                                @foreach ($jenisMangrove as $id => $nama_ilmiah)
                                                    <option value="{{ $id }}"
                                                        {{ $id == $jenis->id ? 'selected' : '' }}>{{ $nama_ilmiah }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-success" id="addJenisMangrove"><i
                                        class="fas fa-plus"></i>Tambah Jenis Mangrove</button>
                            </div>
                            <div class="form-group">
