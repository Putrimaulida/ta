            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/dashboard_admin/pantai/create/store') }}"
                            enctype="multipart/form-data">
                            @csrf
                            <!-- Nama Pantai -->
                            <div class="form-group">
                                <label for="nama_pantai">Nama Pantai:</label>
                                <input type="text" name="nama_pantai" id="nama_pantai" class="form-control" required>
                            </div>
                            <!-- Lokasi -->
                            <div class="form-group">
                                <label for="lokasi_pantai">Lokasi:</label>
                                <input type="text" name="lokasi_pantai" id="lokasi_pantai" class="form-control" required>
                            </div>
                            <!-- Longitude -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="latitude" name="latitude" id="latitude" class="form-control" required>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-primary">Tambah Pantai</button>
                                </div>
                            </div>
                        </form>
                    </div>
