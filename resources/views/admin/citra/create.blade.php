...
@section('container')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Tambah Data Citra Satelit</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/dashboard_admin/citra/create/store') }}">
                            @csrf
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-primary">Tambah Data Citra</button>
                                </div>
                            </div>
                        </form>
                    </div>
